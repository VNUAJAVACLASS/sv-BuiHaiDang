...
<body>
    ...
    <div class="content">
      <div class="content_header">
        ...
        <button class="logout"><a href="logout.jsp"><i class="bi bi-box-arrow-right"></i></a></button>
      </div>

      <div class="action_buttons">
        <button class="btn green"> <a href="adminHome?action=create">+ Tạo sách mới</a></button>
    ...
    <table border="1" cellpadding="5">
        ...
        <c:forEach var="book" items="${bookList}">
            <tr>
                ...
                <td>
                    <a href="adminHome?action=edit&id=${book.bookId}"><i class="bi bi-pencil-square text-success"></i></a> |
                    <a href="adminHome?action=delete&id=${book.bookId}" onclick="return confirm('Xoá sách này?');"> <i class="bi bi-trash text-danger"></i></a>
